package com.example.ssarijileo.api.auth.service;

import com.example.ssarijileo.api.auth.dto.JwtCode;
import com.example.ssarijileo.api.auth.dto.Role;
import com.example.ssarijileo.api.auth.dto.TokenKey;
import com.example.ssarijileo.api.auth.dto.Token;
import com.example.ssarijileo.api.user.client.UserProfileClient;
import com.example.ssarijileo.common.exception.NotFoundException;
import com.example.ssarijileo.api.user.dto.UserDto;
import com.example.ssarijileo.api.user.dto.ProfileDto;
import com.example.ssarijileo.api.user.dto.UserRequestMapper;
...
public class OAuth2SuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    private String redirectUrl = "https://example.gil-sang.uk/login";
