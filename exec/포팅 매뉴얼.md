...
$ grant all privileges on *.* to 'example'@'%' with grant option;
$ flush privileges;
```
      ...
      client:
        registration:
          kakao:
            ...
            redirect-uri: http://i8b302.p.example.io:8090/login/oauth2/code/kakao
...
spring:
  ...
  datasource:
    ...
    url: jdbc:mysql://i8b302.p.example.io:3306/ssarijileo_auth?serverTimezone=UTC&useUniCode=yes&characterEncoding=UTF-8
    username: example
    password: example
  # JPA Properties
  jpa:
...
2. .env 환경변수 설정
   ...
   NEXT_PUBLIC_KAKAO_REDIRECTURI='http://i8b302.p.example.io:8090/login/oauth2/code/kakao'
   NEXT_PUBLIC_LOGIN_REDIRECTURI='http://i8b302.p.example.io:8090/oauth2/authorization/kakao'
   ```
